...
/**
 * The fixed notification recipients. Edit this list to add/remove people; the
 * `id` is what gets persisted in the per-account settings file, so changing an
 * existing id orphans that selection (the name and email are free to change).
 */
const RECIPIENTS = [
...
module.exports = { config: raw, assertConfig, RECIPIENTS, NOTIFY_SEVERITIES };